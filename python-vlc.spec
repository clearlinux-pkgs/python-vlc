...
Version  : 3.0.9113
Release  : 11
URL      : https://files.pythonhosted.org/packages/cf/89/4c9ef5cfe8078a3ccddadd623c29306fcf5b956652e77f17f6b5ce5ff99d/python-vlc-3.0.9113.tar.gz
Source0  : https://files.pythonhosted.org/packages/cf/89/4c9ef5cfe8078a3ccddadd623c29306fcf5b956652e77f17f6b5ce5ff99d/python-vlc-3.0.9113.tar.gz
...
%prep
%setup -q -n python-vlc-3.0.9113
cd %{_builddir}/python-vlc-3.0.9113
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588189428
...
cp %{_builddir}/python-vlc-3.0.9113/COPYING %{buildroot}/usr/share/package-licenses/python-vlc/01a6b4bf79aca9b556822601186afab86e8c4fbf
